    ...
    <section className="bg-white py-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="font-serif text-5xl text-c-text leading-tight mb-6">
              Australia's original van shelving experts
            </h2>
            <p className="text-[15px] text-c-muted leading-relaxed mb-4">
            ...
            <p className="text-[15px] text-c-muted leading-relaxed">
          ...
          {/* Stats — Conicorn uses a scrolling / repeating stat strip */}
          <div className="grid grid-cols-3 gap-6">
            {[
              ...
              <div key={s.label} className="flex flex-col gap-1">
                <span className="font-serif text-5xl text-c-text">{s.val}</span>
                <span className="text-[12px] uppercase tracking-widest text-c-subtle">{s.label}</span>
              </div>
            ))}
          </div>
        </div>
