    ...
    <section className="bg-[#F2F1EE] py-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-serif text-6xl md:text-7xl text-c-text leading-none mb-4">
            RAK Your Van <em className="not-italic text-c-accent">Today</em>
          </h2>
          <p className="text-[15px] text-c-muted">Stop wasting time hunting for tools. Start working smarter.</p>
        </div>
