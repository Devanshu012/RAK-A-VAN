    ...
    <>
      <section className="bg-white py-20 border-b border-[#E8E6E1]">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <h1 className="font-serif text-[72px] leading-none text-c-text mb-4">Find Your<br /><em className="not-italic text-c-accent">Local Distributor</em></h1>
          <p className="text-[15px] text-c-muted max-w-md">A growing network of trusted local distributors who understand your trade.</p>
        </div>
      </section>
      ...
      <section className="bg-[#F8F7F4] py-16">
        <div className="max-w-7xl mx-auto px-6 flex flex-col gap-10">
          ...
          <div className="bg-[#0D0D0D] rounded-3xl p-10 flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <p className="text-[11px] font-medium uppercase tracking-widest text-[#6B6860] mb-2">Join Our Network</p>
              <h2 className="font-serif text-4xl text-white">Become a Distributor</h2>
